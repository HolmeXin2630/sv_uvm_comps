// vip/amba/ahb/tb/ahb_tb_top_pipeline.sv
`ifndef AHB_TB_TOP_PIPELINE_SV
`define AHB_TB_TOP_PIPELINE_SV

module ahb_tb_top_pipeline;
    import uvm_pkg::*;
    import hx_ahb_pkg::*;
