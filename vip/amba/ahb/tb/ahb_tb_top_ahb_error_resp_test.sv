// vip/amba/ahb/tb/ahb_tb_top_error.sv
`ifndef AHB_TB_TOP_ERROR_SV
`define AHB_TB_TOP_ERROR_SV

module ahb_tb_top_error;
    import uvm_pkg::*;
    import hx_ahb_pkg::*;
